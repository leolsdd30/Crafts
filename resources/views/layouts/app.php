            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-8">
                        <a href="<?= APP_URL ?>/" class="<?= $baseNavClass . ' ' . ($isHome ? $activeNavClass : $inactiveNavClass) ?>">
                            Home
                        </a>
                        <a href="<?= APP_URL ?>/search" class="<?= $baseNavClass . ' ' . ($isSearch ? $activeNavClass : $inactiveNavClass) ?>">
                            Find Craftsmen
                        </a>
                        <a href="<?= APP_URL ?>/jobs" class="<?= $baseNavClass . ' ' . ($isJobs ? $activeNavClass : $inactiveNavClass) ?>">
                            Job Board
                        </a>
                    </div>
                </div>
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <a href="<?= APP_URL ?>/profile" class="flex items-center space-x-2 hover:bg-gray-50 p-1.5 pr-3 rounded-full transition-colors duration-200 border border-transparent hover:border-gray-200" title="View Profile">
                            ...
                            <span class="text-sm font-semibold text-gray-700 flex items-center gap-1">
                                ...
                                <svg class="h-4 w-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" title="Verified Professional">
